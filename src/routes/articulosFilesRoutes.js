 ...
 * /api/articulos-files:
 *   get:
 *     summary: Lista todos los archivos de articulos subidos
 *     description: Endpoint para listar todos los archivos de articulos subidos
 *     tags:
 *       - Articulos
 *     responses:
 *       200:
...
router.get('/', listArticulosFiles);

/**
 * @swagger
 * /api/articulos-files/{fileName}:
 *   get:
...
router.get('/:fileName', getFileByNameArticulos);
