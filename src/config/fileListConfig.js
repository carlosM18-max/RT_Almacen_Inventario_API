...
// Listar todos los archivos en el directorio de polizas
export const listPolizasFiles = (req, res) => {
  const directoryPath = path.join(__dirname, '../public/polizas');
...
// Función para obtener un archivo por su nombre
export const getFileByNamePolizas = (req, res) => {
  const { fileName } = req.params;
  const directoryPath = path.join(__dirname, '../public/polizas');
...
// Listar todos los archivos en el directorio de articulos
export const listArticulosFiles = (req, res) => {
  const directoryPath = path.join(__dirname, '../public/articles');
...
// Función para obtener un archivo por su nombre
export const getFileByNameArticulos = (req, res) => {
  const { fileName } = req.params;
  const directoryPath = path.join(__dirname, '../public/articles');
